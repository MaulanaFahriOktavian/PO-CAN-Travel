...
<div class="py-10 sm:py-12">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            <a href="{{ route('admin.routes.index') }}" class="text-sm font-medium text-blue-600 hover:text-blue-800 transition-colors">
        ...
        <div class="bg-white border border-slate-200 rounded-xl p-6 sm:p-8 shadow-sm">
            <form method="POST" action="{{ route('admin.routes.store') }}" class="space-y-5">
                ...
                <div>
                    <label for="origin" class="block text-sm font-medium text-slate-700 mb-1">Kota Asal (Keberangkatan)</label>
                    <input
                        type="text"
                        id="origin"
                        name="origin"
                ...
                <div>
                    <label for="destination" class="block text-sm font-medium text-slate-700 mb-1">Kota Tujuan (Kedatangan)</label>
                    <input
                        type="text"
                        id="destination"
                        name="destination"
                ...
                <div>
                    <label for="duration" class="block text-sm font-medium text-slate-700 mb-1">Estimasi Durasi (Menit)</label>
                    <input
                        type="number"
                        id="duration"
                        name="duration"
                        value="{{ old('duration', 480) }}"
                        min="1"
                        max="1440"
                        required
